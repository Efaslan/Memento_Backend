...
VALUES (1, 'ahmet.amca@test.com', '$2a$10$2pa//C6VUsTQo1kd1djt7OEFqg5DZ7eoZvy7qlbStFDeWk823cmL6', 'Ahmet', 'Yilmaz', '05551112233', 'PATIENT', CURRENT_TIMESTAMP);

INSERT INTO users (id, email, password_hash, first_name, last_name, phone_number, role, created_at)
VALUES (2, 'dr.zeynep@test.com', '$2a$10$2pa//C6VUsTQo1kd1djt7OEFqg5DZ7eoZvy7qlbStFDeWk823cmL6', 'Zeynep', 'Kaya', '05554445566', 'DOCTOR', CURRENT_TIMESTAMP);

INSERT INTO users (id, email, password_hash, first_name, last_name, phone_number, role, created_at)
VALUES (3, 'mehmet.ogul@test.com', '$2a$10$2pa//C6VUsTQo1kd1djt7OEFqg5DZ7eoZvy7qlbStFDeWk823cmL6', 'Mehmet', 'Yilmaz', '05557778899', 'RELATIVE', CURRENT_TIMESTAMP);

INSERT INTO users (id, email, password_hash, first_name, last_name, phone_number, role, created_at)
VALUES (4, 'ayse.kiz@test.com', '$2a$10$2pa//C6VUsTQo1kd1djt7OEFqg5DZ7eoZvy7qlbStFDeWk823cmL6', 'Ayse', 'Demir', '05550001122', 'RELATIVE', CURRENT_TIMESTAMP);
...
INSERT INTO medication_schedules (id, patient_user_id, doctor_user_id, medication_name, dosage, notes, start_date, end_date, is_prn, is_active)
...
-- SCHEDULE TIMES
-- Coraspin (10) -> 09:00
INSERT INTO medication_schedule_times (id, schedule_id, scheduled_time)
VALUES (100, 10, '09:00:00');

-- Insulin (20) -> 08:00 & 20:00
INSERT INTO medication_schedule_times (id, schedule_id, scheduled_time) VALUES (201, 20, '08:00:00');
INSERT INTO medication_schedule_times (id, schedule_id, scheduled_time) VALUES (202, 20, '20:00:00');
...
VALUES (100, 1, CURRENT_TIMESTAMP, 'TAKEN');
