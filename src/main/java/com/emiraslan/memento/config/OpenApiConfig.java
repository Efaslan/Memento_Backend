...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                ...
                .addTagsItem(new Tag().name("04 - Profiles").description("Patient profile information."))
                .addTagsItem(new Tag().name("05 - Relationships").description("Relationships between Patients and their Relatives"))
