...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                ...
                .addTagsItem(new Tag().name("02 - Profiles").description("Patient profile information."))
                .addTagsItem(new Tag().name("03 - Family").description("Patients can create families, and add members from the relationships section."))
                .addTagsItem(new Tag().name("04 - Relationships").description("Relationships between Patients and their Relatives."))
                .addTagsItem(new Tag().name("05 - Saved Locations").description("Saved locations of Patient users."))
                .addTagsItem(new Tag().name("06 - General Reminders").description("Non-medical reminders of Patient users."))
                .addTagsItem(new Tag().name("07 - Daily Logs").description("Food and water consumption logs of Patient users."))
                ...
                .addTagsItem(new Tag().name("11 - Notifications").description("Saving FCM tokens of user devices."))
