...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                ...
                .addTagsItem(new Tag().name("02 - User").description("For email operations and consents."))
                .addTagsItem(new Tag().name("03 - User Devices").description("Managing user tokens and logout."))
                .addTagsItem(new Tag().name("04 - Profiles").description("Patient and Doctor profile information."))
                .addTagsItem(new Tag().name("05 - Relationships").description("Relationships between Patients and their Doctors and/or Relatives"))
