...
public class UserService {
    ...
    @Transactional
    public BasicStringResponse requestEmailChange(Integer userId, String newEmail) {
        ...
        return new BasicStringResponse("OTP_SENT_TO_NEW_EMAIL");
    }

    @Transactional
    public BasicStringResponse verifyAndChangeEmail(Integer userId, String newEmail, String otpCode) {
        ...
        return new BasicStringResponse("EMAIL_SUCCESSFULLY_UPDATED");
    }

    @Transactional
    public BasicStringResponse recordConsent(User user, UserConsentRequest request, String ipAddress, String userAgent){
        ...
        return new BasicStringResponse("CONSENT_RECORDED_SUCCESSFULLY");
    }
}